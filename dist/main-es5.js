...
var Web3Service = /** @class */ (function () {
            ...
            if (typeof window.web3 !== 'undefined') {
                _this.web3.eth.getAccounts(function (err, accs) {
                    ...
                    if (!_this.accounts || _this.accounts.length !== accs.length || _this.accounts[0] !== accs[0]) {
                        ...
                        _this.accounts = accs;
                        localStorage.setItem("userAccount", _this.accounts[0]);
                        console.log('Observed new accounts', _this.accounts);
                    }
                    _this.ready = true;
                });
            }
    ...
    Web3Service.prototype.enableAccounts = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var error_1;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!window.ethereum) return [3 /*break*/, 4];
    ...
    Web3Service.prototype.artifactsToContract = function () {
        console.log("localStorage.getItem", localStorage.getItem("sc"));
        if (this.web3) {
            var instance = new this.web3.eth.Contract(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].ABI.abi, 
    ...
    Web3Service.prototype.getProvider = function () {
        return this.web3.currentProvider;
    };
    Web3Service.prototype.trasfer = function (receiver, sender, value) {
...
var MarketplaceComponent = /** @class */ (function () {
    function MarketplaceComponent(nftService, dataS, snackBar, web3Service) {
        var _this = this;
        ...
        this.dataS.nftData().subscribe(function (data) {
            console.log(data);
    ...
    MarketplaceComponent.prototype.lend = function (data) {
        this.lendData = data;
        if (this.lendData) {
            $('#lend').modal('show');
        }
    };
    MarketplaceComponent.prototype.applyForLoan = function (data) {
    ...
    MarketplaceComponent.prototype.checkClicked = function (val) {
        this.test = !val;
    ...
    MarketplaceComponent.prototype.borrow = function () {
        this.test = false;
        this.t_borrow = true;
        this.t_lend = false;
    };
    MarketplaceComponent.prototype.lendddd = function () {
        this.test = true;
        this.t_lend = true;
        this.t_borrow = false;
    };
    MarketplaceComponent.prototype.slend = function () {
        this.test = true;
        this.t_lend = true;
        this.t_borrow = false;
    };
    MarketplaceComponent.prototype.on = function () {
        document.getElementById("overlay").style.display = "block";
    };
    MarketplaceComponent.prototype.off = function () {
        document.getElementById("overlay").style.display = "none";
    };
    MarketplaceComponent.prototype.user = function () {
        this.userAddress = localStorage.getItem("userAccount");
        console.log("################## NFT #####", this.userAddress);
    };
    MarketplaceComponent.prototype.youGet = function (whrdd) {
        console.log(whrdd.loanamount);
        console.log(whrdd.interest);
        var rr = whrdd.loanAmount.replace(',', '');
        var yyy = whrdd.interest.replace(',', '');
        var y = Number(rr) + Number(yyy);
        return y;
    };
    MarketplaceComponent.prototype.whrDetails = function (h) {
        var _this = this;
        localStorage.setItem("sc", h.sc);
        this.nftService.getWhrDetails().then(function (data) {
            _this.whr = data;
            _this.whr['picture'] = h.picture;
            _this.whr['commodity'] = h.commodity;
            console.log(data);
        });
        this.nftService.balanceOf().then(function (data) {
            console.log(data);
            _this.balanceOf = data;
        });
        this.nftService.totalCal().then(function (data) {
            console.log(data);
            _this.totalCal = data / Math.pow(10, 18);
        });
        this.nftService.totalInt().then(function (data) {
            _this.totalInt = data / Math.pow(10, 18);
        });
        this.nftService.paused().then(function (data) {
            _this.paused = data;
            console.log('paused', data);
        });
        this.nftService.lenderAddress().then(function (data) {
            _this.lenderAddress = data;
            console.log('feeDepositor', _this.lenderAddress);
        });
        this.nftService.repaymentAmount().then(function (data) {
            _this.repaymentAmount = data / Math.pow(10, 18);
        });
        this.nftService.loanAmount().then(function (data) {
            _this.loanAmount = data / Math.pow(10, 18);
            console.log('loanAmount', _this.loanAmount);
        });
        this.nftService.totalSupply().then(function (totalSupply) {
            _this.totalSupply = totalSupply;
            if (_this.totalSupply == 0) {
                _this.mintStatus = true;
            }
            console.log('totalSupply', totalSupply, _this.mintStatus);
        });
        this.nftService.owner().then(function (data) {
            _this.owner = data;
    ...
    MarketplaceComponent.prototype.ownercheck = function () {
        var _this = this;
        this.nftService.owner().then(function (data) {
            _this.owner = data;
            console.log('owner check ', data, _this.userAddress);
            if (data.match(_this.userAddress))
                return true;
            else
                return false;
        });
    };
    MarketplaceComponent.prototype.showWhrDetails = function (h) {
        console.log(h);
        localStorage.setItem("sc", h.sc);
        this.whrDetails(h);
        this.whrdd = h;
    ...
    MarketplaceComponent.prototype.showWhrDetailsbr = function (h) {
        console.log(h);
        localStorage.setItem("sc", h.sc);
        this.whrDetails(h);
        this.whrdd = h;
    ...
    MarketplaceComponent.prototype.borrowerWithdraw = function () {
        var _this = this;
        this.nftService.borrowerWithdraw().then(function (data) {
            // this.whr=data;
            _this.paused = data;
            $('#lendingSuccess').modal('show');
            console.log('data', data);
            _this.tx = "https://ropsten.etherscan.io/tx/" + data["transactionHash"];
            _this.linkToViewLending = data["transactionHash"];
            // this.snackBar.open('You review has been sent', '', {
            //   duration: 2000,
            // });
        });
    };
    MarketplaceComponent.prototype.lenderWithdraw = function () {
        var _this = this;
        this.nftService.lenderWithdraw().then(function (data) {
            // this.whr=data;
            _this.paused = data;
            $('#lendingSuccess').modal('show');
            console.log('data', data);
    ...
    MarketplaceComponent.prototype.sentEth = function (h) {
        var _this = this;
        var sc = localStorage.getItem("sc");
        console.log(sc, this.userAddress, (this.whr.ethprice * (70 / 100)).toString());
        this.nftService.transfer(sc, this.userAddress, ((this.whr.ethprice / 100) * (70 / 100)).toString()).then(function (data) {
            // this.whr=data;
            _this.paused = data;
            $('#lendingSuccess').modal('show');
            console.log('data', data);
            ...
            _this.tx = err.message;
            $('#seccessmsg').modal('show');
        }
        // alert(err.message)
        );
    };
    MarketplaceComponent.prototype.repaymentEth = function () {
        var _this = this;
        var sc = localStorage.getItem("sc");
        console.log(sc, this.userAddress, (this.whr.ethprice * (70 / 100)).toString());
        this.nftService.transfer(sc, this.userAddress, ((this.whr.ethprice / 100) * (70 / 100)).toString()).then(function (data) {
    ...
    MarketplaceComponent.prototype.mint = function () {
        var _this = this;
        this.nftService.owner().then(function (data) {
            _this.nftService.mint(data).then(function (data) {
                $('#lendingSuccess').modal('show');
                console.log('data', data);
                _this.tx = "https://ropsten.etherscan.io/tx/" + data["transactionHash"];
                _this.linkToViewLending = data["transactionHash"];
    ...
    MarketplaceComponent.prototype.stringToint = function (str) {
        // console.log(str);
        var rr = str.replace(',', '');
        var n = Number(rr);
        return n;
    };
    MarketplaceComponent.prototype.getImageName = function (val) {
        var tt = val.replace('/', '').trim();
        var t = tt.replace(' ', '');
        console.log(t);
        return t;
    };
...
var MyloansComponent = /** @class */ (function () {
    function MyloansComponent() {
    }
    MyloansComponent.prototype.ngOnInit = function () {
    };
...
var ContractComponent = /** @class */ (function () {
    function ContractComponent(nftService, snackBar, web3Service) {
        this.nftService = nftService;
        this.snackBar = snackBar;
        this.web3Service = web3Service;
        this.mintStatus = false;
    ...
    ContractComponent.prototype.user = function () {
        this.userAddress = localStorage.getItem("sc");
        console.log("################## NFT #####", this.userAddress);
    };
    ContractComponent.prototype.whrDetails = function (h) {
        var _this = this;
        this.nftService.getWhrDetails().then(function (data) {
            _this.whr = data;
            _this.whr['picture'] = h.picture;
    ...
    //   });
    // }
    ContractComponent.prototype.mintShatusCheck = function (h) {
        var _this = this;
    ...
    ContractComponent.prototype.showWhrDetails = function (h) {
        console.log(h);
        localStorage.setItem("sc", h.sc);
        this.whrDetails(h);
        // window.location.href = '/sc';
    ...
    ContractComponent.prototype.borrowerWithdraw = function () {
        var _this = this;
        this.nftService.borrowerWithdraw().then(function (data) {
            // this.whr=data;
            _this.paused = data;
    ...
    ContractComponent.prototype.lenderWithdraw = function () {
        var _this = this;
        this.nftService.lenderWithdraw().then(function (data) {
            // this.whr=data;
            _this.paused = data;
    ...
    ContractComponent.prototype.sentEth = function () {
        var _this = this;
        var sc = localStorage.getItem("sc");
        console.log(sc, this.userAddress, (this.whr.ethprice * (70 / 100)).toString());
        this.nftService.transfer(sc, this.userAddress, (this.whr.ethprice * (70 / 100)).toString()).then(function (data) {
            // this.whr=data;
            _this.paused = data;
            // this.snackBar.open('You review has been sent', '', {
            //   duration: 2000,
    ...
    ContractComponent.prototype.repaymentEth = function () {
        var _this = this;
        var sc = localStorage.getItem("sc");
        console.log(sc, this.userAddress, (this.whr.ethprice * (70 / 100)).toString());
        this.nftService.transfer(sc, this.userAddress, (this.whr.ethprice * (70 / 100)).toString()).then(function (data) {
    ...
    ContractComponent.prototype.mint = function (h) {
        var _this = this;
        localStorage.setItem("sc", h.sc);
        this.nftService.owner().then(function (data) {
            _this.nftService.mint(data).then(function (data) {
...
var NftsComponent = /** @class */ (function () {
    function NftsComponent(nftService, snackBar, web3Service) {
        this.nftService = nftService;
        this.snackBar = snackBar;
        this.web3Service = web3Service;
        this.mintStatus = false;
    ...
    NftsComponent.prototype.ngOnInit = function () {
        this.user();
        console.log('("################## sc', localStorage.getItem("sc") ? localStorage.getItem("sc") : '0x57F801F99c1a53aa9f124aE3c6662Dec9B5ddCA9');
    };
    NftsComponent.prototype.user = function () {
        this.userAddress = localStorage.getItem("sc");
        console.log("################## NFT #####", this.userAddress);
    };
    NftsComponent.prototype.whrDetails = function (h) {
        var _this = this;
        this.nftService.getWhrDetails().then(function (data) {
            _this.whr = data;
            _this.whr['picture'] = h.picture;
    ...
    NftsComponent.prototype.showWhrDetails = function (h) {
        console.log(h);
        localStorage.setItem("sc", h.sc);
        this.whrDetails(h);
        // window.location.href = '/sc';
    ...
    NftsComponent.prototype.borrowerWithdraw = function () {
        var _this = this;
        this.nftService.borrowerWithdraw().then(function (data) {
            // this.whr=data;
            _this.paused = data;
            $('#seccessmsg').modal('show');
            console.log('data', data);
            _this.tx = "Transactiondata " + data["transactionHash"] + "completed successfully.. ";
            // this.snackBar.open('You review has been sent', '', {
            //   duration: 2000,
            // });
        });
    };
    NftsComponent.prototype.lenderWithdraw = function () {
        var _this = this;
        this.nftService.lenderWithdraw().then(function (data) {
            // this.whr=data;
            _this.paused = data;
    ...
    NftsComponent.prototype.sentEth = function () {
        var _this = this;
        var sc = localStorage.getItem("sc");
        console.log(sc, this.userAddress, (this.whr.ethprice * (70 / 100)).toString());
        this.nftService.transfer(sc, this.userAddress, ((this.whr.ethprice / 100) * (70 / 100)).toString()).then(function (data) {
    ...
    NftsComponent.prototype.repaymentEth = function () {
        var _this = this;
        var sc = localStorage.getItem("sc");
        console.log(sc, this.userAddress, (this.whr.ethprice * (70 / 100)).toString());
        this.nftService.transfer(sc, this.userAddress, ((this.whr.ethprice / 100) * (70 / 100)).toString()).then(function (data) {
    ...
    NftsComponent.prototype.mint = function () {
        var _this = this;
        this.nftService.owner().then(function (data) {
            _this.nftService.mint(data).then(function (data) {
                $('#seccessmsg').modal('show');
...
var dataService = /** @class */ (function () {
    ...
    dataService.prototype.nftData = function () {
...
var ABI = __webpack_require__(/*! ../../build_ropsten/contracts/nftToken.json */ "./build_ropsten/contracts/nftToken.json");
var environment = {
    production: false,
    networkID: 3,
